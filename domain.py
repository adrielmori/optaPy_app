...
def generate_problem():
    ...
    teacher_list = [
        ...
        Teacher(
            2, "Reinaldo de Souza Júnior", create_date(2021, 8), create_date(1993, 12)
        ),
        Teacher(
            3, "Fábio Nogueira de Lucena", create_date(2024, 1), create_date(1997, 12)
        ),
        ...
        Teacher(13, "William Divino Ferreira", create_date(2022, 12)),
        Teacher(14, "Rubens de Castro Pereira"),
        Teacher(15, "Edison Andrade Martins Morais"),
        Teacher(16, "Adailton Ferreira de Araújo", create_date(2023, 11)),
        Teacher(17, "Hugo Nascimento", create_date(2022, 12)),
        Teacher(18, "Leonardo Antonio Alves", create_date(2023, 11)),
        Teacher(
            19,
...
teacher_list = [
    ...
    Teacher(2, "Reinaldo de Souza Júnior", create_date(2021, 8), create_date(1993, 12)),
    Teacher(3, "Fábio Nogueira de Lucena", create_date(2024, 1), create_date(1997, 12)),
    Teacher(4, "Taciana Novo Kudo", create_date(2016, 3), create_date(1990, 2)),
    Teacher(5, "Renata Dutra Braga"),
    Teacher(6, "Ana Claudia Bastos Loureiro Monção"),
    Teacher(7, "Sofia Larissa da Costa Paiva"),
